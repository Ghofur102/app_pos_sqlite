...
import 'package:app_pos_sqlite/screens/transactions/txn_detail_screen.dart';
...
void main() {
  ...
  if (!kIsWeb && (Platform.isWindows || Platform.isLinux || Platform.isMacOS)) {
    ...
    print("===== Menggunakan Database Factory Standar (Mobile atau Web). =====");
  }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        "/detail-transaksi": (context) => const TxnDetailScreen(),
        "/nota-pembelian": (context) => ReceiptScreen()
      },
    );
  }
}
